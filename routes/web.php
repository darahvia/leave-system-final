...
// Non-teaching (employee) routes - Grouped under 'leave/employee' prefix
Route::prefix('leave/employee')->group(function () {
    Route::get('/', [LeaveController::class, 'index'])->name('leave.index'); // Changed name from leave.employee.index to leave.index for consistency with previous blade
